...
product_ids=[]
while True:
    user = input("Please input a product identifier, or 'DONE' if there are no more items:")
    if user != "DONE":
         product_ids.append(user)
    elif user == "DONE":
         break
...
###format for price_usd is from the groceries assignment
### in Prof Rossetti's class
def lookup_id(id):
...
print ("-------------------------")
print("THE FANCY DELI")
print("-------------------------")
print("Web: www.thefancydeli.com")
print("Phone: 112-358-1321")
...
print("-------------------------")
print("Thank you for stopping by. Come again, come hungry.")
